      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center py-4 gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
            <Link
              to="/"
              className="text-gray-200 hover:text-white transition text-lg cursor-pointer"
            >
              Events
            </Link>
            {user ? (
              <>
                ...
                <button
                  ...
                  className="bg-gray-700 hover:bg-black text-white text-lg px-4 py-2 rounded-md transition"
                >
                  Logout
                </button>
              </>
